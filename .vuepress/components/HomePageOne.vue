<template>
  <article class="home-page-one-wrapper">
      ...
      <div>
        ...
        <!-- <div>
          ...
          >
            <img
              alt="GitHub license"
              src="https://img.shields.io/github/license/vuepress-reco/vuepress-theme-reco?&logo=github"
            />
          </a>
          <a
            target="_black"
          ...
          >
            <img
              alt="GitHub stars"
              src="https://img.shields.io/github/stars/vuepress-reco/vuepress-theme-reco?style=flat&logo=github"
            />
          </a>
          <a
            target="_black"
          ...
          >
            <img
              alt="GitHub forks"
              src="https://img.shields.io/github/forks/vuepress-reco/vuepress-theme-reco?style=flat&logo=github"
            />
          </a>
          <a
            target="_black"
            href="https://www.npmjs.com/package/vuepress-theme-reco"
          >
            <img
              alt="Npm downloads"
              src="https://img.shields.io/npm/dt/vuepress-theme-reco?style=flat&logo=npm"
            />
          </a>
          <a
            target="_black"
          ...
          >
            <img
              alt="Npm version"
              src="https://img.shields.io/npm/v/vuepress-theme-reco.svg?style=flat&logo=npm&label=version"
            />
          </a>
        </div> -->
    ...
    <section class="wish today">
      <div class="wish-inner">
        <div class="text-wrapper">
          <h1>{{ features[3].title }}</h1>
          <p class="description">{{ features[3].details }}</p>
        </div>
        <div class="img-wrapper">
          <img src="./images/today.svg" alt="" />
        </div>
    ...
    <section class="wish tomorrow">
      <div class="wish-inner">
        ...
        <div class="text-wrapper">
          <h1>{{ features[4].title }}</h1>
          <p class="description">{{ features[4].details }}</p>
        </div>
      </div>
    </section>
    <section class="wish today">
      <div class="wish-inner">
        <div class="text-wrapper">
          <h1>{{ features[5].title }}</h1>
          <p class="description">{{ features[5].details }}</p>
        </div>
        <div class="img-wrapper">
          <img src="./images/today.svg" alt="" />
        </div>
    ...
    <section class="wish tomorrow">
      <div class="wish-inner">
        ...
        <div class="text-wrapper">
          <h1>{{ features[6].title }}</h1>
          <p class="description">{{ features[6].details }}</p>
        </div>
      </div>
    </section>
